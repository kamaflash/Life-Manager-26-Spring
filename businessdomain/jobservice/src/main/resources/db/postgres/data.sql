...
(1, 1, 28000, 35000, 'FULL_TIME', 'HYBRID', 3, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Buscamos un Desarrollador Full Stack apasionado por la tecnología para unirse a nuestro equipo. Trabajarás con React y Spring Boot en proyectos innovadores. Ofrecemos un ambiente dinámico y oportunidades de crecimiento.'),
(2, 2, 50000, 70000, 'FULL_TIME', 'REMOTE', 2, 40, true, false, CURRENT_DATE, '10:00:00', '19:00:00', 'Desarrollador Senior con experiencia en liderazgo técnico y arquitectura de soluciones. Valoramos capacidad de mentoría y toma de decisiones.'),
(3, 3, 40000, 55000, 'FULL_TIME', 'HYBRID', 2, 40, true, false, CURRENT_DATE, '08:30:00', '17:30:00', 'Data Scientist para análisis de datos y modelos predictivos. Buscamos personas con pasión por los datos y la inteligencia artificial.'),
(4, 4, 60000, 80000, 'FULL_TIME', 'ONSITE', 2, 40, true, false, CURRENT_DATE, '08:00:00', '17:00:00', 'Médico General para atención primaria y consulta médica. Jornada completa en centro de salud.'),
(5, 5, 28000, 35000, 'FULL_TIME', 'ONSITE', 5, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Enfermero para cuidado de pacientes y asistencia médica. Se valorará experiencia en urgencias.'),
(6, 6, 30000, 40000, 'FULL_TIME', 'ONSITE', 3, 40, true, false, CURRENT_DATE, '08:00:00', '15:00:00', 'Fisioterapeuta para rehabilitación y terapia física. Horario intensivo.'),
(7, 7, 32000, 42000, 'FULL_TIME', 'ONSITE', 4, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Asesor Financiero para asesoramiento a clientes y gestión de carteras. Buscamos personas con habilidades comerciales.'),
(8, 8, 45000, 60000, 'FULL_TIME', 'HYBRID', 2, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Analista de Riesgos para evaluación y gestión de riesgos financieros. Modelado y análisis de datos.'),
(9, 9, 55000, 75000, 'FULL_TIME', 'HYBRID', 1, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Gestor de Patrimonios para planificación financiera y gestión de inversiones de alto patrimonio.'),
(10, 10, 40000, 55000, 'FULL_TIME', 'ONSITE', 2, 40, true, false, CURRENT_DATE, '08:00:00', '17:00:00', 'Ingeniero de Obra para supervisión de obras y gestión de proyectos de construcción.'),
(11, 11, 45000, 60000, 'FULL_TIME', 'HYBRID', 2, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Arquitecto para diseño y planificación de proyectos arquitectónicos residenciales y comerciales.'),
(12, 12, 26000, 34000, 'FULL_TIME', 'REMOTE', 3, 40, true, false, CURRENT_DATE, '10:00:00', '19:00:00', 'Diseñador de Interiores para diseño de espacios y selección de materiales. Trabajo remoto con visitas puntuales.'),
(13, 13, 28000, 36000, 'FULL_TIME', 'REMOTE', 3, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Profesor de Programación para impartir cursos de desarrollo web. Experiencia en Java y Python.'),
(14, 14, 25000, 32000, 'FULL_TIME', 'ONSITE', 4, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Profesor de Inglés para clases a adultos y empresas. Nivel C1 mínimo.'),
(15, 15, 26000, 34000, 'FULL_TIME', 'REMOTE', 3, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Diseñador Gráfico para diseño de materiales visuales y branding. Dominio de Adobe Suite.'),
(16, 16, 26000, 34000, 'FULL_TIME', 'HYBRID', 2, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Editor de Video para edición y postproducción de contenido audiovisual. Conocimiento de Premiere y After Effects.'),
(17, 17, 26000, 34000, 'FULL_TIME', 'ONSITE', 3, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Trabajador Social para atención a colectivos vulnerables y seguimiento de casos.'),
(18, 18, 32000, 42000, 'FULL_TIME', 'HYBRID', 2, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Coordinador de Proyectos Sociales para gestión de proyectos de inclusión social.'),
(19, 19, 24000, 30000, 'FULL_TIME', 'ONSITE', 3, 40, true, false, CURRENT_DATE, '08:00:00', '15:00:00', 'Técnico de Laboratorio para análisis y experimentación en laboratorio. Formación en química o biología.'),
(20, 20, 40000, 55000, 'FULL_TIME', 'ONSITE', 2, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Investigador para investigación y desarrollo de proyectos científicos. Doctorado valorado.'),
(21, 21, 18000, 24000, 'PART_TIME', 'ONSITE', 6, 20, true, false, CURRENT_DATE, '17:00:00', '22:00:00', 'Camarero para atención al cliente en restaurante. Horario de tardes/noches.'),
(22, 22, 20000, 28000, 'FULL_TIME', 'ONSITE', 4, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Cocinero para preparación de platos en cocina. Experiencia en cocina mediterránea.'),
(23, 23, 19000, 25000, 'FULL_TIME', 'ONSITE', 4, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Recepcionista para atención al público y gestión de reservas. Buen nivel de inglés.'),
(24, 24, 20000, 28000, 'PART_TIME', 'ONSITE', 4, 20, true, false, CURRENT_DATE, '16:00:00', '20:00:00', 'Monitor Deportivo para coordinación de actividades deportivas. Titulación en deporte.'),
(25, 25, 30000, 40000, 'FULL_TIME', 'HYBRID', 2, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Entrenador Personal para entrenamiento personalizado y planes de ejercicio. Certificación requerida.'),
(26, 26, 30000, 40000, 'FULL_TIME', 'ONSITE', 1, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Curador de Arte para gestión de exposiciones y colecciones artísticas. Formación en historia del arte.'),
(27, 27, 24000, 32000, 'PART_TIME', 'REMOTE', 2, 20, true, false, CURRENT_DATE, '15:00:00', '19:00:00', 'Artista Plástico para creación de obras de arte. Portfolio requerido.'),
(28, 28, 22000, 30000, 'FULL_TIME', 'REMOTE', 3, 40, true, false, CURRENT_DATE, '09:00:00', '18:00:00', 'Asesor de Empleo para orientación laboral a estudiantes. Experiencia en RRHH.'),
