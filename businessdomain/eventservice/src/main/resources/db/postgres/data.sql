...
VALUES ('EVENT_NEWYEAR_001', '🎆 Año Nuevo', 'Festivo nacional. Celebra el inicio del año con familia y amigos.', 'Un nuevo año trae nuevas oportunidades y propósitos.', 'PROJECT_SUCCESS', 'GLOBAL', NULL, '2026-01-01 00:00:00', '2026-01-01 23:59:59', true, '0 0 0 1 1 ? *', 999999, 1440, 'IN_PROGRESS', true, 'https://cdn.example.com/events/newyear-icon.png', 'https://cdn.example.com/events/newyear-banner.jpg', NOW());
...
-- ENERO - Reyes Magos
INSERT INTO events (code, title, description, lore, type, scope, city, start_date, end_date, recurring, cron_expression, max_participants, duration_minutes, status, auto_trigger, icon_url, banner_url, created_at)
VALUES ('EVENT_KINGS_001', '👑 Día de Reyes', 'Los Reyes Magos traen ilusión y regalos. Tradición familiar.', 'La magia de la infancia nunca se pierde.', 'PROJECT_SUCCESS', 'GLOBAL', NULL, '2026-01-06 00:00:00', '2026-01-06 23:59:59', true, '0 0 0 6 1 ? *', 999999, 1440, 'IN_PROGRESS', true, 'https://cdn.example.com/events/kings-icon.png', 'https://cdn.example.com/events/kings-banner.jpg', NOW());
...
-- MARZO - Día del Padre
INSERT INTO events (code, title, description, lore, type, scope, city, start_date, end_date, recurring, cron_expression, max_participants, duration_minutes, status, auto_trigger, icon_url, banner_url, created_at)
VALUES ('EVENT_FATHERS_DAY_001', '👔 Día del Padre', 'Homenaje a los padres. Celebra con tu familia.', 'Un padre es un héroe sin capa.', 'PROJECT_SUCCESS', 'GLOBAL', NULL, '2026-03-19 00:00:00', '2026-03-19 23:59:59', true, '0 0 0 19 3 ? *', 999999, 1440, 'IN_PROGRESS', true, 'https://cdn.example.com/events/fathers-icon.png', 'https://cdn.example.com/events/fathers-banner.jpg', NOW());
...
-- ABRIL - Jueves Santo
INSERT INTO events (code, title, description, lore, type, scope, city, start_date, end_date, recurring, cron_expression, max_participants, duration_minutes, status, auto_trigger, icon_url, banner_url, created_at)
VALUES ('EVENT_HOLY_THURSDAY_001', '⛪ Jueves Religioso', 'Inicio de la Semana Santa. Procesiones y tradición.', 'La Semana Santa es cultura, fe y tradición.', 'PROJECT_SUCCESS', 'GLOBAL', NULL, '2026-04-02 00:00:00', '2026-04-02 23:59:59', true, '0 0 0 2 4 ? *', 999999, 1440, 'IN_PROGRESS', true, 'https://cdn.example.com/events/holy-icon.png', 'https://cdn.example.com/events/holy-banner.jpg', NOW());
...
-- ABRIL - Viernes Santo
INSERT INTO events (code, title, description, lore, type, scope, city, start_date, end_date, recurring, cron_expression, max_participants, duration_minutes, status, auto_trigger, icon_url, banner_url, created_at)
VALUES ('EVENT_GOOD_FRIDAY_001', '⛪ Viernes Santo', 'Día de recogimiento y tradición.', 'El silencio también habla.', 'PROJECT_SUCCESS', 'GLOBAL', NULL, '2026-04-03 00:00:00', '2026-04-03 23:59:59', true, '0 0 0 3 4 ? *', 999999, 1440, 'IN_PROGRESS', true, 'https://cdn.example.com/events/goodfriday-icon.png', 'https://cdn.example.com/events/goodfriday-banner.jpg', NOW());
...
INSERT INTO events (code, title, description, lore, type, scope, city, start_date, end_date, recurring, cron_expression, max_participants, duration_minutes, status, auto_trigger, icon_url, banner_url, created_at)
VALUES ('EVENT_LABOR_DAY_001', '👷 Día del Trabajador', 'Festivo nacional. Homenaje a todos los trabajadores.', 'El trabajo dignifica, el descanso también es necesario.', 'PROJECT_SUCCESS', 'GLOBAL', NULL, '2026-05-01 00:00:00', '2026-05-01 23:59:59', true, '0 0 0 1 5 ? *', 999999, 1440, 'IN_PROGRESS', true, 'https://cdn.example.com/events/labor-icon.png', 'https://cdn.example.com/events/labor-banner.jpg', NOW());
...
INSERT INTO events (code, title, description, lore, type, scope, city, start_date, end_date, recurring, cron_expression, max_participants, duration_minutes, status, auto_trigger, icon_url, banner_url, created_at)
VALUES ('EVENT_MOTHERS_DAY_001', '💐 Día de la Madre', 'Homenaje a las madres. Celebra con tu familia.', 'Madre solo hay una.', 'PROJECT_SUCCESS', 'GLOBAL', NULL, '2026-05-03 00:00:00', '2026-05-03 23:59:59', true, '0 0 0 3 5 ? *', 999999, 1440, 'IN_PROGRESS', true, 'https://cdn.example.com/events/mothers-icon.png', 'https://cdn.example.com/events/mothers-banner.jpg', NOW());
...
INSERT INTO events (code, title, description, lore, type, scope, city, start_date, end_date, recurring, cron_expression, max_participants, duration_minutes, status, auto_trigger, icon_url, banner_url, created_at)
VALUES ('EVENT_ASUNCION_001', '⛪ Asunción de la Virgen', 'Festivo nacional. Tradición y celebración religiosa.', 'El verano está en su punto más álgido.', 'PROJECT_SUCCESS', 'GLOBAL', NULL, '2026-08-15 00:00:00', '2026-08-15 23:59:59', true, '0 0 0 15 8 ? *', 999999, 1440, 'IN_PROGRESS', true, 'https://cdn.example.com/events/asuncion-icon.png', 'https://cdn.example.com/events/asuncion-banner.jpg', NOW());
...
INSERT INTO events (code, title, description, lore, type, scope, city, start_date, end_date, recurring, cron_expression, max_participants, duration_minutes, status, auto_trigger, icon_url, banner_url, created_at)
VALUES ('EVENT_HISPANIDAD_001', '🇪🇸 Día de la Hispanidad', 'Fiesta nacional. Desfile militar y celebraciones patrióticas.', 'Orgullo de ser hispano.', 'PROJECT_SUCCESS', 'GLOBAL', NULL, '2026-10-12 00:00:00', '2026-10-12 23:59:59', true, '0 0 0 12 10 ? *', 999999, 1440, 'IN_PROGRESS', true, 'https://cdn.example.com/events/hispanidad-icon.png', 'https://cdn.example.com/events/hispanidad-banner.jpg', NOW());
...
INSERT INTO events (code, title, description, lore, type, scope, city, start_date, end_date, recurring, cron_expression, max_participants, duration_minutes, status, auto_trigger, icon_url, banner_url, created_at)
VALUES ('EVENT_ALL_SAINTS_001', '🕯️ Día de Todos los Santos', 'Festivo nacional. Recuerda a tus seres queridos.', 'La memoria es el corazón de la tradición.', 'PROJECT_SUCCESS', 'GLOBAL', NULL, '2026-11-01 00:00:00', '2026-11-01 23:59:59', true, '0 0 0 1 11 ? *', 999999, 1440, 'IN_PROGRESS', true, 'https://cdn.example.com/events/allsaints-icon.png', 'https://cdn.example.com/events/allsaints-banner.jpg', NOW());
...
INSERT INTO events (code, title, description, lore, type, scope, city, start_date, end_date, recurring, cron_expression, max_participants, duration_minutes, status, auto_trigger, icon_url, banner_url, created_at)
VALUES ('EVENT_CONSTITUTION_001', '📜 Día de la Constitución', 'Festivo nacional. Celebra nuestra Carta Magna.', 'La constitución nos une como nación.', 'PROJECT_SUCCESS', 'GLOBAL', NULL, '2026-12-06 00:00:00', '2026-12-06 23:59:59', true, '0 0 0 6 12 ? *', 999999, 1440, 'IN_PROGRESS', true, 'https://cdn.example.com/events/constitution-icon.png', 'https://cdn.example.com/events/constitution-banner.jpg', NOW());
...
INSERT INTO events (code, title, description, lore, type, scope, city, start_date, end_date, recurring, cron_expression, max_participants, duration_minutes, status, auto_trigger, icon_url, banner_url, created_at)
VALUES ('EVENT_IMMACULATE_001', '⛪ Inmaculada Concepción', 'Festivo nacional. Tradición y recogimiento.', 'La pureza y la fe se celebran.', 'PROJECT_SUCCESS', 'GLOBAL', NULL, '2026-12-08 00:00:00', '2026-12-08 23:59:59', true, '0 0 0 8 12 ? *', 999999, 1440, 'IN_PROGRESS', true, 'https://cdn.example.com/events/immaculate-icon.png', 'https://cdn.example.com/events/immaculate-banner.jpg', NOW());
...
INSERT INTO events (code, title, description, lore, type, scope, city, start_date, end_date, recurring, cron_expression, max_participants, duration_minutes, status, auto_trigger, icon_url, banner_url, created_at)
VALUES ('EVENT_CHRISTMAS_EVE_001', '🎄 Nochebuena', 'Cena familiar y celebración navideña.', 'La magia de la Navidad comienza en Nochebuena.', 'PROJECT_SUCCESS', 'GLOBAL', NULL, '2026-12-24 00:00:00', '2026-12-24 23:59:59', true, '0 0 0 24 12 ? *', 999999, 1440, 'IN_PROGRESS', true, 'https://cdn.example.com/events/christmaseve-icon.png', 'https://cdn.example.com/events/christmaseve-banner.jpg', NOW());
...
-- DICIEMBRE - Navidad
INSERT INTO events (code, title, description, lore, type, scope, city, start_date, end_date, recurring, cron_expression, max_participants, duration_minutes, status, auto_trigger, icon_url, banner_url, created_at)
VALUES ('EVENT_CHRISTMAS_DAY_001', '🎄 Navidad', 'Festivo nacional. Celebra en familia el nacimiento de Jesús.', 'La Navidad es amor, paz y esperanza.', 'PROJECT_SUCCESS', 'GLOBAL', NULL, '2026-12-25 00:00:00', '2026-12-25 23:59:59', true, '0 0 0 25 12 ? *', 999999, 1440, 'IN_PROGRESS', true, 'https://cdn.example.com/events/christmas-icon.png', 'https://cdn.example.com/events/christmas-banner.jpg', NOW());
...
INSERT INTO events (code, title, description, lore, type, scope, city, start_date, end_date, recurring, cron_expression, max_participants, duration_minutes, status, auto_trigger, icon_url, banner_url, created_at)
VALUES ('EVENT_NEWYEAR_EVE_001', '🎆 Nochevieja', 'Despide el año con las 12 uvas y celebración.', 'El año nuevo está a la vuelta de la esquina.', 'PROJECT_SUCCESS', 'GLOBAL', NULL, '2026-12-31 00:00:00', '2026-12-31 23:59:59', true, '0 0 0 31 12 ? *', 999999, 1440, 'IN_PROGRESS', true, 'https://cdn.example.com/events/newyeareve-icon.png', 'https://cdn.example.com/events/newyeareve-banner.jpg', NOW());
