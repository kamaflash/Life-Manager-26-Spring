...
-- ============================================
-- 3. JOB VACANCIES (CORREGIDO - sin remote_friendly)
-- ============================================
...
-- 5. JOB EVENTS
-- ============================================
INSERT INTO job_events (type, title, description, salary_change, performance_change, satisfaction_change, stress_change, resolved) VALUES
('BONUS', '¡Bono por rendimiento!', 'Has superado las expectativas este mes. La empresa te reconoce con un bono económico.', 300, 10, 15, -5, false),
('BONUS', 'Bono por objetivos', 'Has cumplido todos los objetivos del trimestre. ¡Buen trabajo!', 500, 15, 20, -10, false),
('PROMOTION', '¡Ascenso!', 'Tu trabajo ha sido reconocido. Has sido ascendido a un puesto superior.', 400, 20, 25, 10, false),
('PROMOTION', 'Cambio de rol', 'Te han ofrecido un nuevo rol con más responsabilidades y mejor salario.', 350, 15, 20, 15, false),
('CONFLICT', 'Desacuerdo con compañero', 'Has tenido un conflicto con un compañero de trabajo por diferencias de opinión.', 0, -10, -15, 15, false),
('CONFLICT', 'Problemas con el jefe', 'Has tenido un desencuentro con tu supervisor directo.', 0, -15, -20, 20, false),
('PROJECT_SUCCESS', 'Proyecto exitoso', 'El proyecto en el que has trabajado ha sido un éxito rotundo.', 200, 15, 20, -10, false),
('PROJECT_SUCCESS', 'Reconocimiento público', 'La dirección ha reconocido públicamente tu contribución al proyecto.', 0, 10, 25, -5, false),
('PROJECT_FAILURE', 'Proyecto fallido', 'El proyecto no ha alcanzado los objetivos esperados.', 0, -15, -20, 15, false),
('PROJECT_FAILURE', 'Retraso en la entrega', 'No se ha cumplido con la fecha de entrega del proyecto.', 0, -10, -15, 10, false),
('BURNOUT', 'Agotamiento laboral', 'El exceso de trabajo está pasando factura a tu salud mental.', 0, -20, -25, 25, false),
('BURNOUT', 'Necesitas un descanso', 'Llevas muchas horas trabajando sin descanso.', 0, -10, -10, 15, false),
('OFFER_FROM_RIVAL', 'Oferta de la competencia', 'Una empresa rival te ha ofrecido un puesto con mejores condiciones.', 0, 0, 10, 5, false),
('MENTOR_LEAVES', 'Tu mentor se va', 'La persona que te mentorizaba ha dejado la empresa.', 0, -10, -15, 10, false),
('TEAM_RESTRUCTURE', 'Reestructuración del equipo', 'La empresa ha reorganizado los equipos.', 0, -5, -10, 15, false),
('QUARTERLY_REVIEW', 'Revisión trimestral positiva', 'Tu evaluación trimestral ha sido excelente.', 200, 10, 15, -10, false),
('QUARTERLY_REVIEW', 'Revisión trimestral negativa', 'Tu evaluación trimestral no ha sido buena.', 0, -10, -15, 15, false),
('DEMOTION', 'Descenso de categoría', 'Por motivos organizativos, tu puesto ha sido reajustado a la baja.', -200, -15, -25, 20, false);
