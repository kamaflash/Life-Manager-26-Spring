...
public class StressCalculator {
    ...
    private static final int STRESS_INCREASE_PER_STUDY_HOUR = 3;   // +2 estrés por hora de estudio
    private static final int STRESS_INCREASE_PER_WORK_HOUR = 3;    // +4 estrés por hora de trabajo
