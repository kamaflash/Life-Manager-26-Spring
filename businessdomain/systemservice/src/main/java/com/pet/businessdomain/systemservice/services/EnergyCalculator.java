...
public class EnergyCalculator {
    ...
    private static final int ENERGY_COST_PER_WORK_HOUR = -6;  // -8 energía por hora de trabajo

    public int calculateForRest(long hours) {
        int energyGain = (int) (hours * ENERGY_GAIN_PER_REST_HOUR);
        return Math.min(energyGain, 100);
    }
